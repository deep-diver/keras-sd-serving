...
In [this notebook](https://colab.research.google.com/github/deep-diver/keras-sd-serving/blob/main/tfs_saved_models_xla.ipynb), we show how we can XLA-compile the SavedModels to achieve a speed-up of about 52% over the [non-XLA variant](https://colab.research.google.com/github/deep-diver/keras-sd-serving/blob/main/tfs_saved_models.ipynb). 
