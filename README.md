...
- **TF Serving Endpoint**: [[Colab](https://colab.research.google.com/github/deep-diver/keras-sd-serving/blob/main/notebooks/tfs_three_endpoints.ipynb) | [Dockerfiles + k8s Resources](https://github.com/deep-diver/keras-sd-serving/tree/main/tfserving)]
  ...
  - Docker Image(text-encoder `base64`): `gcr.io/gcp-ml-172005/tfs-sd-text-encoder-base64:latest`
  - Docker Image(text-encoder-v2): `gcr.io/gcp-ml-172005/tfs-sd-text-encoder-v2:latest`
  - Docker Image(text-encoder-v2 `base64`): `gcr.io/gcp-ml-172005/tfs-sd-text-encoder-v2-base64:latest`
  - Docker Image(diffusion-model): `gcr.io/gcp-ml-172005/tfs-sd-diffusion-model:latest`
  - Docker Image(diffusion-model `base64`): `gcr.io/gcp-ml-172005/tfs-sd-diffusion-model-base64:latest`
  - Docker Image(diffusion-model-v2): `gcr.io/gcp-ml-172005/tfs-sd-diffusion-model-v2:latest`
  - Docker Image(diffusion-model-v2 `base64`): `gcr.io/gcp-ml-172005/tfs-sd-diffusion-model-v2-base64:latest`
  - Docker Image(decoder): `gcr.io/gcp-ml-172005/tfs-sd-decoder:latest`  
  - Docker Image(decoder `base64`): `gcr.io/gcp-ml-172005/tfs-sd-decoder-base64:latest`
